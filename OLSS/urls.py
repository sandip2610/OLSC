...
urlpatterns = [
    ...
    path('student/<int:student_id>/documents/', views.student_documents, name='student_documents'),
    path('student/<int:student_id>/documents/add/', views.add_document, name='add_document'),
